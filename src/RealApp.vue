...
import { Bell, BookOpen, Check, ChevronLeft, ChevronRight, Eye, EyeOff, FileText, Gauge, Inbox, LayoutDashboard, LockKeyhole, LogOut, Menu, MessageSquare, MoreHorizontal, Plus, Send, Settings, ShieldCheck, Sparkles, Upload, Users, X } from 'lucide-vue-next'
